                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('level') ? ' has-error' : '' }}">
                            <label for="level" class="col-md-4 control-label">REGISTER AS</label>
                            
                            <div class="col-md-6">
                                <select name="level" id="level" class="form-control" required autofocus>
                                    <option value="">...</option>
                                    <option value="d" {{ old('level')=='d' ? 'selected' : '' }}>Doctor</option>
                                    <option value="sw" {{ old('level')=='sw' ? 'selected' : '' }}>Social Worker</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('specialty') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select name="specialty" id="specialty" class="form-control" value="{{ old('specialty') }}" autofocus>
                                    <option value="">...</option>
                                    <option value="Specialty 1" {{ old('status')=='d' ? 'selected' : '' }}>Specialty 1</option>
                                    <option value="Specialty 2" {{ old('status')=='sw' ? 'selected' : '' }}>Specialty 2</option>
                                </select>
